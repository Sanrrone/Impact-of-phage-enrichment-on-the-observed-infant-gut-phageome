...
kraken2 --db $new/software/hep_bactDB/k2/hepbact --confidence 0.5 --threads $c --use-names --report ${sname}.k2c05.kreport --output /dev/null ${home_project}/5_phages_readmapback/nomap/${sname}_virnomap.fq.gz
